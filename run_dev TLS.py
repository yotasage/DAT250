...
ssl_cert = "certificate/MyCertificate.crt"
ssl_key = "certificate/MyKey.key"
...
app.run(host='localhost', port=443, debug=True, ssl_context=(ssl_cert, ssl_key))  # Runs the server in development mode using the integrated server in Flask
