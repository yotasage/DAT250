...
subject = "Flask test email, sent from server as " + os.environ.get('MAIL_USERNAME_FLASK')
body="text body"
html = '<b>Test mail from the Flask server of ' + DOMAIN_NAME + ' </b><br> <br> This mail is sent from ' + os.environ.get('MAIL_USERNAME_FLASK') + ', who is a representative of ' + DOMAIN_NAME
...
def send_mail(sender=None, recipients=recipients, subject=subject, body=body, html=html):
    # Konstruer melding
    if sender is None:
