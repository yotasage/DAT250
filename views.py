...
def header():
    ...
    whitelist = ['startside.html', 'din_side.html', 'edit.html', 'transaction_view.html']
    ...
    if session_cookie is not None and ('Referer' in request.headers and request.host_url in request.headers['Referer'] and allowed):
